...
namespace Kuvox.Api.Modules.Auth.Repositories.Migrations
{
    ...
    [Migration("20260630000000_AddUserPreferences")]
            ...
            modelBuilder.Entity("Kuvox.Api.Modules.Auth.Models.AuthToken", b =>
                {
                    ...
                    b.Property<string>("Purpose").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)");
                    b.Property<string>("TokenHash").IsRequired().HasMaxLength(128).HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("Kuvox.Api.Modules.Auth.Models.RefreshToken", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt").HasColumnType("timestamp with time zone");
                    b.Property<DateTimeOffset>("ExpiresAt").HasColumnType("timestamp with time zone");
                    b.Property<string>("ReplacedByTokenHash").HasMaxLength(128).HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("Kuvox.Api.Modules.Auth.Models.User", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
                    b.Property<DateTimeOffset>("CreatedAt").HasColumnType("timestamp with time zone");
                    b.Property<string>("DefaultEditorMode").IsRequired().HasMaxLength(16).HasColumnType("character varying(16)");
                    ...
                    b.Property<DateTimeOffset?>("EmailVerifiedAt").HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("Plan").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)");
                    b.Property<bool>("ProductUpdatesEnabled").HasColumnType("boolean");
                    b.Property<DateTimeOffset>("UpdatedAt").HasColumnType("timestamp with time zone");
                    b.Property<bool>("WeeklyDigestEnabled").HasColumnType("boolean");
                    b.HasKey("Id");
